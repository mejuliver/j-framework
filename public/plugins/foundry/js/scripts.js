...
$(document).ready(function() { 
    ...
    // modified by juliver, added hide and fadeIn effect to tabs
    $(document).on('click','.tabs li',function() {
        $(this).closest('.tabs').find('li').removeClass('active');
        $(this).addClass('active');
        var liIndex = $(this).index() + 1;
        $(this).closest('.tabbed-content').find('.content>li').removeClass('active').hide();
        $(this).closest('.tabbed-content').find('.content>li:nth-of-type(' + liIndex + ')').addClass('active').fadeIn();
        //run the given functions from the set options data-run
            if(typeof $(this).attr('data-run') !== typeof undefined && $(this).attr('data-run') !== false && $(this).attr('data-run') !== "") {
                var classList = $(this).attr('data-run').split(/\s+/);
    ...
    $('.module.widget-handle').click(function() {
        ...
        if($(this).hasClass('active')){
            $(this).find('i').removeClass('ti-menu').addClass('ti-close c-dark');
        }else{
             $(this).find('i').removeClass('ti-close c-dark').addClass('ti-menu');
        }
    });
    ...
    //extend modal by julive. initialize modal
    $('body').append('<div class="modal-container hide"> <a class="btn btn-lg btn-modal" href="#f-modal" id="f-modal-trigger-button"></a> <div class="foundry_modal" id="f-modal"> <h4 class="f-modal-title"></h4> <hr> <div class="f-modal-body"> </div></div></div>');
